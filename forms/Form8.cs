...
namespace hellenicair2
{
    partial class Form8 : Form
    {
        ...
        private void flight101ToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.flights3TableAdapter.flight101(this.flightsDataSet.flights3, flightIDToolStripTextBox.Text);
            }
