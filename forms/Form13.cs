...
namespace hellenicair2
{
    partial class Form13 : Form
    {
        ...
        private void flight200ToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.flights3TableAdapter.flight200(this.flightsDataSet.flights3, flightIDToolStripTextBox.Text);
            }
